    ...
    <div className="p-6 max-w-4xl mx-auto space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-[var(--text-strong)] flex items-center gap-2">
          <Users size={22} className="text-[#E55A2B]" />
          Comensales
        </h1>
      ...
      {loading ? (
        ...
        <div className="bg-[var(--surface-sunken)] border border-[var(--border-subtle)] rounded-2xl p-10 text-center">
          <Users size={32} className="text-[var(--text-muted)] mx-auto mb-3" />
          <p className="text-[var(--text-muted)] text-sm">Aún no hay comensales reconocidos en tu restaurante.</p>
        </div>
      ) : (
          ...
          {customers.map((c) => (
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <p className="text-[var(--text-strong)] font-medium text-sm truncate">{c.display_name}</p>
              ...
              <div className="text-right shrink-0">
                <p className="text-[#E55A2B] font-semibold text-sm flex items-center gap-1 justify-end">
