    ...
    <div className="space-y-5">
      ...
      <div className="space-y-2">
          ...
          <div key={index} className="flex items-center gap-2">
            <div className="flex-1 relative">
              ...
              <input
                ...
                placeholder="0"
                className="w-full bg-black/30 border border-[var(--border-subtle)] rounded-xl pl-7 pr-3 py-2.5 text-[var(--text-strong)] text-sm focus:outline-none focus:border-[#FF6B35]/50 transition-colors"
            ...
            {amounts.length > 1 && (
              <button
                ...
                className="w-9 h-9 rounded-lg bg-red-500/10 border border-red-500/20 flex items-center justify-center text-red-700 hover:bg-red-500/20 transition-colors"
              >
                <X size={14} />
              </button>
            )}
        ...
        {amounts.length < 10 && (
          <button
            ...
            className="w-full py-2.5 rounded-xl border border-dashed border-[var(--border-subtle)] text-[var(--text-muted)] text-sm hover:border-[var(--border-subtle)] hover:text-[var(--text-muted)] transition-colors flex items-center justify-center gap-2"
          >
            <Plus size={14} />
            Agregar división
          </button>
      ...
      <div className={`rounded-xl p-4 border ${
        ...
        <div className="flex items-center justify-between mb-2">
          <span className="text-[var(--text-muted)] text-xs">Suma de divisiones</span>
